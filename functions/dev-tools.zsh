...
_cpwd_precmd() {
    (( _cpwd_nudge_pending )) || return
    _cpwd_nudge_pending=0
    # No backticks here: in a double-quoted print they'd command-substitute and
    # actually run cpwd, copying to the clipboard as a side effect of the hint.
...
add-zsh-hook precmd  _cpwd_precmd
